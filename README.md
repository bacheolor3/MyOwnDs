## 🛠️ Key Features (주요 구현 기능)

### 1. Character & Action Control (캐릭터 및 액션 제어)
* **Finite State Machine (FSM):** 상태 머신을 활용하여 이동, 구르기(무적 프레임), 공격, 피격 등 캐릭터 액션 상태 유기적 연결
...
* 거리에 따른 근접/원거리 공격 패턴 분기 및 플레이어 추적 로직 설계
